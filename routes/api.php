...
Route::prefix('mpesa')->group(function () {
    Route::middleware(VerifyMpesaCallback::class)->group(function () {
...
Route::prefix('platform')->middleware(['auth:sanctum', 'platform_admin'])->group(function () {
    ...
    // Platform Users — READ-ONLY list of who holds platform-admin access.
    // is_platform_admin is CLI-only (platform:make-admin); there is no
    // create/edit/delete route for this resource.
    Route::get('/users', [PlatformAdminController::class, 'platformUsers']);
    ...
    Route::prefix('billing')->group(function () {
        ...
        Route::get('/stats', [PlatformBillingController::class, 'stats']);
        Route::get('/invoices/{invoice}', [PlatformBillingController::class, 'show']);
        Route::get('/invoices/{invoice}/pdf', [PlatformBillingController::class, 'pdf']);
        Route::post('/invoices/generate', [PlatformBillingController::class, 'generate']);
        Route::post('/invoices/{invoice}/send', [PlatformBillingController::class, 'send']);
        Route::post('/invoices/{invoice}/resend', [PlatformBillingController::class, 'resend']);
    ...
    Route::prefix('reports')->group(function () {
        Route::get('/revenue', [PlatformReportController::class, 'revenue']);
        Route::get('/tenants', [PlatformReportController::class, 'tenants']);
        Route::get('/usage', [PlatformReportController::class, 'usage']);
        Route::get('/{type}/export', [PlatformReportController::class, 'export']);
    });
});
