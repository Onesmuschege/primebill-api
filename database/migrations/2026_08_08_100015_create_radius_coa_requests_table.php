...
return new class extends Migration
{
    ...
    {
        Schema::create('radius_coa_requests', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('action'); // disconnect, coa, bandwidth_change, vlan_change
            $table->json('attributes')->nullable(); // RADIUS attributes to send
    ...
    {
        Schema::dropIfExists('radius_coa_requests');
    }
};
